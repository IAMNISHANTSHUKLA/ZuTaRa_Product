...
export default function JobListingsPageContent() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background to-secondary/50 pt-8 text-foreground"> {/* Adjusted pt-20 to pt-8 as header is now part of global layout */}
