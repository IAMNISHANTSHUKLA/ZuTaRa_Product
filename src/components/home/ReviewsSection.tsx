...
const reviews = [
  {
    ...
    imageSrc: "https://placehold.co/120x120/77B5B0/FFFFFF?text=HV",
  ...
  },
  {
    ...
    imageSrc: "https://placehold.co/120x120/2E7DAF/FFFFFF?text=SC",
  ...
  },
  {
    ...
    imageSrc: "https://placehold.co/120x120/A0A0A0/FFFFFF?text=NS",
...
export default function ReviewsSection() {
  return (
    <section className="py-16 template-section">
      <div className="template-content template-reviews-wrapper flex-col">
          ...
          {reviews.map((review) => (
            <div key={review.name} className="template-review-card">
              <Image 
                ...
                width={120} 
                height={120} 
                className="rounded-full mx-auto" // Image size already defined in template.css or here
