      ...
      <main className="container mx-auto px-4 py-8 mt-20">
        <Card className="shadow-lg">
          <CardHeader className="text-center">
            <CardTitle className="text-4xl font-bold text-primary">About ArchConnect</CardTitle>
          </CardHeader>
          <CardContent className="space-y-6 text-lg text-foreground">
            ...
            <p>
              Welcome to ArchConnect, the premier platform dedicated to bridging the gap between
            ...
            <p>
              At ArchConnect, we believe in the power of connection. Whether you're a seasoned architectural firm
              looking to showcase your portfolio, a client with a dream project waiting to be realized, or a
              student eager to gain hands-on experience through internships, ArchConnect provides the tools
            ...
            <h2 className="text-2xl font-semibold text-accent pt-4">Why ArchConnect?</h2>
            ...
            <p className="pt-4">
              Join ArchConnect today and be a part of revolutionizing how architectural projects come to life.
            </p>
          </CardContent>
        </Card>
      </main>
